export default {
    ...
    card_wath_descr: 'Глядзіце ў меню (Пазлей)',
    ...
    account_premium: 'Раскрыйце новыя гарызонты з акаўнтам CUB Premium! Атрымлівайце асалоду ад павялічанымі лімітамі і ўзбагачаным функцыяналам сэрвісу. Перайдзіце на сайт <span class="account-modal__site">{site}/premium</span> і даведайцеся больш пра перавагі прэміум акаўнта.',
    ...
    account_premium_include_text_5: 'Не прапусціце ніводнай новай серыі або перакладу! Атрымлівайце апавяшчэння своечасова і будзьце ў курсе ўсіх абнаўленняў. Павялічце свой кінаструмень разам з намі і атрымлівайце апавяшчэнні аб выхадзе новых серый і перакладаў прама на свой смартфон.',
    ...
    terminal_confirm: 'Дазволіць',
    terminal_deny: 'Забараніць',
    terminal_update: 'Абнавіць',
    terminal_code: 'Код доступу',
    terminal_text: 'Вы запытваеце доступ да тэрміналу. Распрацоўшчыкі могуць атрымаць доступ да вашай прылады і кіраваць ёй. Гэта можа быць карысна для дыягностыкі і ліквідацыі праблем, але таксама можа ўяўляць рызыку бяспекі. Калі ласка, пераканайцеся, што вы давяраеце распрацоўшчыкам, перш чым даваць доступ. <br><br>Вы можаце ў любы момант адключыць гэтую функцыю, націснуўшы кнопку "Забараніць".',

    title_anons: 'Анонс',
    title_developer: 'Распрацоўшчык',
    title_navigation: 'Навігацыя',
    title_page: 'Старонка',
    title_person_about: 'Пра чалавека',
    account_qr_premium: 'Адскануйце QR-код, каб даведацца больш пра CUB Premium',
    account_qr_code: 'Адскануйце QR-код, каб атрымаць код для прывязкі прылады',
    account_qr_create: 'Адскануйце QR-код, каб стварыць уліковы запіс',
    account_add_device_title: 'Дадаць прыладу',
    account_add_device_text: 'Перайдзіце на <span class="account-modal__site">{site}/add</span>, каб атрымаць код для дадання прылады.',
    account_none_title: 'Яшчэ няма ўліковага запісу?',
    account_none_include_1: 'Закладкі і гісторыя праглядаў захоўваюцца ў воблаку',
    account_none_include_2: 'Сінхранізацыя паміж прыладамі',
    account_none_include_3: 'Апавяшчэнні пра новыя серыі і рэлізы',
    account_none_include_4: 'Стварайце некалькі профіляў у адным уліковым запісе',
    account_premium_include_1: 'Павялічаная колькасць закладак',
    account_premium_include_2: 'Пашыраная гісторыя праглядаў',
    account_premium_include_3: 'Больш даступных таймкодаў',
    account_premium_include_4: 'Колькасць профіляў на адзін уліковы запіс',
    empty_subscribes_title: 'Вашы падпіскі на пераклады',
    empty_subscribes_text: 'Проста падпішыцеся на ўлюбёны пераклад, і мы паведамім вам, калі выйдзе новая серыя.',
    empty_history_title: 'Ваша гісторыя праглядаў',
    empty_history_text: 'Ваша гісторыя праглядаў з’явіцца тут.',
    empty_bookmark_title: 'Вашы абраныя',
    empty_bookmark_text: 'Дадавайце фільмы і серыялы, якія вам падабаюцца, у абраныя, каб хутка знаходзіць іх у гэтым раздзеле.',
    empty_mytorrents_title: 'Вашы торэнты',
    empty_mytorrents_text: 'Торэнты, загружаныя праз TorServer, з’явяцца тут.',
    ...
    developer_trigger_help_3: 'Вы ўпэўнены, што хочаце ўвайсці ў рэжым распрацоўшчыка?',
    developer_trigger_help_4: 'Рэжым распрацоўшчыка актываваны',
    settings_param_navigation_touch: 'Сэнсар',
    account_discuss_add_qr: 'Адскануйце QR-код',
    account_discuss_add_title: 'Хочаце пакінуць каментар?',
    account_discuss_add_text: 'Адскануйце QR-код, каб перайсці ў дадатак і пакінуць каментар да гэтага фільма ці серыяла. <br><br> - Вазьміце тэлефон або планшэт <br> - Адкрыйце камеру <br> - Навядзіце на QR-код <br> - Перайдзіце па спасылцы, якая з’явіцца на экране',
    account_discuss_added: 'Дзякуй за ваш каментар!',
    account_discuss_added_ready: 'Вы ўжо пакідалі каментар да гэтага фільма ці серыяла.',
    remote_helper_long: 'Утрымлівайце кнопку (OK), каб адкрыць меню',
    ...
    title_best_of_2010: 'Хіты 2010-х', 
    title_best_of_2015: 'Сучасная класіка', 
    title_comedy_of_2000: 'Смех 2000-х', 
    title_comedy_of_2010: 'Гумар 2010-х', 
    title_comedy_of_2015: 'Сучасныя камедыі',

    filter_keyword_sequel: 'Сіквел', 
    filter_keyword_based_comic: 'Па коміксах', 
    filter_keyword_space: 'Космас', 
    filter_keyword_survival: 'Выжыванне', 
    filter_keyword_zombie: 'Зомбі', 
    filter_keyword_school: 'Школа', 
    filter_keyword_revenge: 'Помста', 
    filter_keyword_detective: 'Дэтэктыў', 
    filter_keyword_robots: 'Робаты', 
    filter_keyword_vampires: 'Вампіры', 
    filter_keyword_aliens: 'Іншапланецяне', 
    filter_keyword_police: 'Паліцыя', 
    filter_keyword_reincarnation: 'Перараджэнне', 
