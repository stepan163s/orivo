export default {
    ...
    settings_request_caching_use: 'Кэширование запросов',
    settings_request_caching_descr: 'Сохранять ответы от серверов в кэш для ускорения работы приложения',
    ...
    account_profile_child: 'Детский',
    account_profile_add: 'Добавить профиль',
    account_profile_name: 'Имя профиля',
    account_profile_created: 'Профиль успешно создан',
    account_profile_limited: 'Достигнут максимальный лимит профилей: {count}',
    account_profile_info: 'Вы можете управлять профилями в настройках аккаунта, для этого перейдите на сайт <span class="account-modal__site">{site}/profiles</span>',
