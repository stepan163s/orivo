export default {
    ...
    title_anons: 'Oznámení',
    title_developer: 'Vývojář',
    ...
    account_none_include_1: 'Záložky a historie sledování se ukládají do cloudu',
    account_none_include_2: 'Synchronizace mezi zařízeními',
    account_none_include_3: 'Upozornění na nové epizody a vydání',
    account_none_include_4: 'Vytvářejte více profilů pod jedním účtem',
    account_premium_include_1: 'Zvětšený počet záložek',
    account_premium_include_2: 'Rozšířená historie sledování',
    account_premium_include_3: 'Více dostupných časových značek',
    account_premium_include_4: 'Počet profilů na jeden účet',
    empty_subscribes_title: 'Vaše odběry překladů',
    empty_subscribes_text: 'Stačí se přihlásit k odběru oblíbeného překladu a my vás upozorníme, až vyjde nová epizoda.',
    empty_history_title: 'Vaše historie sledování',
    empty_history_text: 'Vaše historie sledování se zobrazí zde.',
    empty_bookmark_title: 'Vaše oblíbené',
    ...
    title_best_of_2010: 'Hity 21. století',
    title_best_of_2015: 'Moderní klasika',
    title_comedy_of_2000: 'Smích 21. století',
    title_comedy_of_2010: 'Humor 21. století',
    title_comedy_of_2015: 'Moderní komedie',

    filter_keyword_sequel: 'Pokračování',
    filter_keyword_based_comic: 'Na motivy komiksu',
    filter_keyword_space: 'Vesmír',
    filter_keyword_survival: 'Přežití',
    filter_keyword_zombie: 'Zombie',
    filter_keyword_school: 'Škola',
    filter_keyword_revenge: 'Pomsta',
    filter_keyword_detective: 'Detektiv',
    filter_keyword_robots: 'Roboti',
    filter_keyword_vampires: 'Upíři',
    filter_keyword_aliens: 'Vetřelci',
    filter_keyword_police: 'Policie',
    filter_keyword_reincarnation: 'Reinkarnace',
