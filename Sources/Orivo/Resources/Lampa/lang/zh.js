export default {
    ...
    settings_cub_sync_descr: '与 CUB 服务同步：同步您的书签、浏览历史、标签和时间码。',
    ...
    fav_sync_title: '书签同步',
    fav_sync_text: '您最喜欢的书签。连接同步并在任何设备上查看。<br><br>为此，请在网站 {site} 上注册，创建个人资料并登录应用程序.',
    fav_sync_site: '网站',
    ...
    notice_none: '您还没有任何通知，请在 <b>{site}</b> 注册关注新剧集和发布。',
    ...
    account_code_where: '请前往<span class="account-add-device__site">{site}/add</span>网站，并输入该网站上提供的验证码。',
    account_code_input: '输入验证码',
    settings_cub_signin_button: '登录',

    account_limited: '您已达到最大限制。 使用 CUB Premium 帐户提高限制。 在 <span class="account-modal__site">{site}/premium</span> 了解更多信息',
    ...
    account_qr_premium: '扫描二维码以了解更多关于 CUB Premium 的信息',
    account_qr_code: '扫描二维码以获取设备绑定代码',
    account_qr_create: '扫描二维码以创建账户',
    account_add_device_title: '添加设备',
    account_add_device_text: '前往 <span class="account-modal__site">{site}/add</span> 获取添加设备的代码。',
    account_none_title: '还没有账户？',
    account_none_include_1: '书签和观看历史保存在云端',
    account_none_include_2: '多设备同步',
    account_none_include_3: '新剧集和新片发布通知',
    account_none_include_4: '一个账户可创建多个个人资料',
    account_premium_include_1: '增加书签数量',
    account_premium_include_2: '扩展的观看历史',
    account_premium_include_3: '更多可用的时间码',
    account_premium_include_4: '每个账户的个人资料数量',
    empty_subscribes_title: '您的翻译订阅',
    empty_subscribes_text: '只需订阅您喜欢的翻译，我们会在新剧集发布时通知您。',
    ...
    developer_param_enabled: '开发者模式',
    developer_param_nopremium: '禁用 CUB Premium',
    developer_param_nodemo: '禁用演示模式',
    developer_param_ads: '显示广告',
    developer_param_fps: '显示 FPS',
    developer_trigger_help_1: '差一点就猜到了 :)',
    developer_trigger_help_2: '再接近一点 :)',
    developer_trigger_help_3: '您确定要进入开发者模式吗？',
    developer_trigger_help_4: '开发者模式已激活',
    settings_param_navigation_touch: '触控',
    account_discuss_add_qr: '扫描二维码',
    account_discuss_add_title: '想要发表评论吗？',
    account_discuss_add_text: '扫描二维码进入应用程序，为此电影或电视剧添加评论。<br><br> - 拿起您的手机或平板 <br> - 打开相机 <br> - 对准二维码 <br> - 点击屏幕上出现的链接',
    account_discuss_added: '感谢您的评论！',
    account_discuss_added_ready: '您已经为此电影或电视剧发表过评论。',
    remote_helper_long: '长按 (OK) 键打开菜单',
    account_premium: '通过 CUB Premium 账户解锁新体验！享受更高的限制和更强大的功能。访问 <span class="account-modal__site">{site}/premium</span> 了解更多高级账户的优势。',
    ...
    player_segments_skip_now: '跳过',
    player_segments_skip_in: '跳过倒计时',
    player_segments_skip_intro: '跳过片头',
    player_segments_next: '下一集',
    player_segments_next_in: '下一集倒计时',
