export default {
    ...
    account_qr_premium: 'Escaneie o código QR para saber mais sobre o CUB Premium',
    account_qr_code: 'Escaneie o código QR para obter o código de vinculação do dispositivo',
    account_qr_create: 'Escaneie o código QR para criar uma conta',
    account_add_device_title: 'Adicionar dispositivo',
    account_add_device_text: 'Acesse <span class="account-modal__site">{site}/add</span> para obter um código e adicionar o dispositivo.',
    account_none_title: 'Ainda não tem uma conta?',
    account_none_include_1: 'Favoritos e histórico de exibição são salvos na nuvem',
    account_none_include_2: 'Sincronização entre dispositivos',
    account_none_include_3: 'Notificações sobre novos episódios e lançamentos',
    account_none_include_4: 'Crie vários perfis em uma única conta',
    account_premium_include_1: 'Número aumentado de favoritos',
    account_premium_include_2: 'Histórico de exibição expandido',
    account_premium_include_3: 'Mais marcadores de tempo disponíveis',
    account_premium_include_4: 'Número de perfis por conta',
    empty_subscribes_title: 'Suas assinaturas de tradução',
    empty_subscribes_text: 'Basta se inscrever na sua tradução favorita e nós avisaremos quando um novo episódio for lançado.',
    ...
    developer_param_enabled: 'Modo desenvolvedor',
    developer_param_nopremium: 'Desativar CUB Premium',
    developer_param_nodemo: 'Desativar modo de demonstração',
    developer_param_ads: 'Mostrar anúncios',
    developer_param_fps: 'Mostrar FPS',
    developer_trigger_help_1: 'Quase acertou :)',
    developer_trigger_help_2: 'Mais um pouco :)',
    developer_trigger_help_3: 'Tem certeza de que deseja entrar no modo desenvolvedor?',
    developer_trigger_help_4: 'Modo desenvolvedor ativado',
    settings_param_navigation_touch: 'Sensor',
    account_discuss_add_qr: 'Escaneie o código QR',
    account_discuss_add_title: 'Quer deixar um comentário?',
    account_discuss_add_text: 'Escaneie o código QR para abrir o aplicativo e deixar um comentário sobre este filme ou série. <br><br> - Pegue seu celular ou tablet <br> - Abra a câmera <br> - Aponte para o código QR <br> - Siga o link que aparecer na tela',
    account_discuss_added: 'Obrigado pelo seu comentário!',
    account_discuss_added_ready: 'Você já deixou um comentário sobre este filme ou série.',
    remote_helper_long: 'Segure o botão (OK) para abrir o menu',
    account_premium: 'Desbloqueie novos horizontes com uma conta CUB Premium! Aproveite limites maiores e funcionalidades aprimoradas. Visite <span class="account-modal__site">{site}/premium</span> e saiba mais sobre os benefícios da conta premium.',
