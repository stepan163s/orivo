export default {
    ...
    settings_cub_sync_descr: 'Sincronizare cu serviciul CUB: marcaje, istoric de vizionare, etichete și progresul vizionării.',
    ...
    settings_cub_sync_btn_descr: 'Salvează marcajele locale în contul CUB',
    ...
    torrent_parser_sort_by_seeders: 'După seederi',
    ...
    torrent_parser_no_hash: 'Eșec la obținerea HASH-ului, încearcă să repornești TorrServer-ul',
    ...
    title_history: 'Istoric vizualizări',
    title_mytorrents: 'Torrentele mele',
    title_last: 'Ultimele',
    title_action: 'Acțiune',
    title_action_infuse: 'Acțiune Infuse',
    ...
    fav_sync_title: 'Sincronizare marcaje',
    fav_sync_text: 'Marcajele tale preferate. Conectează sincronizarea și vizualizează pe orice dispozitiv. <br><br>Pentru asta, înregistrează-te pe site-ul {site}, creează un profil și autentifică-te în aplicație.',
    ...
    player_youtube_no_played: 'Ne pare rău, acest video nu este disponibil în regiunea ta. Este posibil să fi fost blocat sau șters.',
    ...
    card_book_remove: 'Elimină din marcaje',
    card_book_add: 'La marcaje',
    card_book_descr: 'Vezi în meniu (Marcaje)',
    card_like_remove: 'Elimină din favorite',
    card_like_add: 'Îmi place',
    card_like_descr: 'Vezi în meniu (Îmi place)',
    card_wath_remove: 'Elimină din lista de așteptare',
    card_wath_add: 'Vizionează mai târziu',
    card_wath_descr: 'Vezi în meniu (Mai târziu)',
    card_history_remove: 'Elimină din istoric',
    card_history_add: 'În istoric',
    card_history_descr: 'Vezi în meniu (Istoric)',
    ...
    account_sync_to_profile: 'Toate marcajele vor fi mutate în profil',
    account_sync_secuses: 'Toate marcajele au fost transferate cu succes',
    ...
    account_none_include_1: 'Marcajele și istoricul vizualizărilor sunt salvate în cloud',
    ...
    empty_bookmark_title: 'Lista ta de favorite',
