export default {
    ...
    settings_cub_sync_descr: 'Синхронізація із сервісом CUB: синхронізація ваших закладок, історії переглядів, міток та тайм-кодів.',
    ...
    fav_sync_text: 'Ваші улюблені закладки разом із Вами. Підключіть синхронізацію та переглядайте на будь-якому пристрої. <br><br>Для цього зареєструйтесь на сайті {site}, створіть профіль та авторизуйтесь у додаток.',
    fav_sync_site: 'Сайт',
    ...
    notice_none: 'У вас ще немає жодних повідомлень, зареєструйтесь на сайті <b>{site}</b>, щоб стежити за новими серіями та релізами.',
    ...
    account_create: 'Відкрийте більше можливостей з облікового запису CUB. Зареєструйтесь на сайті <span class="account-modal__site">{site}</span> та отримайте доступ до синхронізації ваших закладок, тайм-кодів та інших можливостей облікового запису CUB.',
    account_premium: 'Розкрийте нові горизонти з обліковим записом CUB Premium! Насолоджуйтесь збільшеними лімітами та збагаченим функціоналом сервісу. Перейдіть на сайт <span class="account-modal__site">{site}/premium</span> та дізнайтесь більше про переваги преміум акаунту.',
    account_premium_more: 'Докладніше про CUB Premium',
    account_limited: 'Ви досягли максимального ліміту. Збільште ліміт з обліковим записом CUB Premium. Докладніше на сайті <span class="account-modal__site">{site}/premium</span>',
    ...
    account_code_where: 'Перейдіть на сайт <span class="account-add-device__site">{site}/add</span> та введіть вказаний там код.',
    ...
    install_app_apk_text: 'Ми помітили, що для запуску Lampa на Android ви використовуєте MediaStationX. Ми рекомендуємо вам встановити Lampa як APK-додатки. Це забезпечить більш стабільну роботу та доступ до всіх функцій програми. <br><br>Перейдіть до групи <span class="account-modal__site">@lampa_group</span> у Телеграмі, щоб скачати останню версію APK та інструкції з встановлення.', 
    ...
    install_extension_rule_1: 'Встановлення стороннього плагіна',
    install_extension_rule_2: 'Плагіни створюються незалежними розробниками, і LAMPA не перевіряє їхній вміст. Встановлюючи їх, ви погоджуєтеся з тим, що:',
    install_extension_rule_3: '- Деякі плагіни можуть запитувати доступ до ваших даних або працювати з неперевіреними джерелами.',
    install_extension_rule_4: '- Якщо встановлений вами плагін порушує авторські права або інші закони, уся відповідальність за його використання лежить на вас.',
    ...
    account_qr_premium: 'Скануйте QR-код, щоб дізнатися більше про CUB Premium',
    account_qr_code: 'Скануйте QR-код, щоб отримати код для прив’язки пристрою',
    account_qr_create: 'Скануйте QR-код, щоб створити обліковий запис',
    account_add_device_title: 'Додати пристрій',
    account_add_device_text: 'Перейдіть на <span class="account-modal__site">{site}/add</span>, щоб отримати код для додавання пристрою.',
    account_none_title: 'Ще не маєте облікового запису?',
    account_none_include_1: 'Закладки та історія переглядів зберігаються у хмарі',
    account_none_include_2: 'Синхронізація між пристроями',
    account_none_include_3: 'Сповіщення про нові серії та релізи',
    account_none_include_4: 'Створюйте кілька профілів в одному обліковому записі',
    account_premium_include_1: 'Збільшена кількість закладок',
    account_premium_include_2: 'Розширена історія переглядів',
    account_premium_include_3: 'Більше таймкодів доступно',
    account_premium_include_4: 'Кількість профілів на один обліковий запис',
    empty_subscribes_title: 'Ваші підписки на переклади',
    empty_subscribes_text: 'Просто підпишіться на улюблений переклад, і ми повідомимо вас, коли вийде нова серія.',
    ...
    developer_param_enabled: 'Режим розробника',
    developer_param_nopremium: 'Вимкнути CUB Premium',
    developer_param_nodemo: 'Вимкнути демо-режим',
    developer_param_ads: 'Показувати рекламу',
    developer_param_fps: 'Показувати FPS',
    developer_trigger_help_1: 'Майже вгадали :)',
    developer_trigger_help_2: 'Ще трохи :)',
    developer_trigger_help_3: 'Ви впевнені, що хочете увійти в режим розробника?',
    developer_trigger_help_4: 'Режим розробника активовано',
    settings_param_navigation_touch: 'Сенсор',
    account_discuss_add_qr: 'Скануйте QR-код',
    account_discuss_add_title: 'Хочете залишити коментар?',
    account_discuss_add_text: 'Скануйте QR-код, щоб перейти до застосунку та залишити коментар до цього фільму чи серіалу. <br><br> - Візьміть телефон або планшет <br> - Відкрийте камеру <br> - Наведіть на QR-код <br> - Перейдіть за посиланням, що з’явиться на екрані',
    account_discuss_added: 'Дякуємо за ваш коментар!',
    account_discuss_added_ready: 'Ви вже залишали коментар до цього фільму чи серіалу.',
    remote_helper_long: 'Утримуйте кнопку (OK), щоб відкрити меню',
    account_premium: 'Відкрийте нові горизонти з обліковим записом CUB Premium! Насолоджуйтесь збільшеними лімітами та розширеними можливостями сервісу. Відвідайте <span class="account-modal__site">{site}/premium</span>, щоб дізнатися більше про переваги преміум-акаунта.',
