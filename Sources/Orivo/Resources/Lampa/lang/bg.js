export default {
    ...
    settings_cub_sync_descr: 'Синхронизация с CUB сървиза: Синхронизиране на вашите отметки, история на сърфиране, тагове и времеви кодове.',
    ...
    account_code_where: 'Отидете на <span class="account-add-device__site">{site}/add</span> website и въведете предоставения там код.',
    ...
    termsofuse_t_01: 'Условия за ползване',
    termsofuse_t_02: 'Lampa е удобен инструмент за разглеждане на най-новите новини в киноиндустрията, включително филми, телевизионни сериали, анимации и друга информация. За получаване на информация за филми се използва уебсайт с отворен код – themoviedb.org.',
    termsofuse_t_03: 'Съдържание',
    termsofuse_t_04: 'Lampa използва API (интерфейс за програмиране на приложения) на каталога themoviedb.org, за да извлича информация за филми и телевизионни сериали, както и за преглед на свързани медийни файлове като плакати, трейлъри и други.',
    termsofuse_t_05: 'API на themoviedb.org позволява на приложението Lampa достъп до база данни с филми и телевизионни сериали, осигурявайки възможност за търсене и преглед на информация за медийни файлове.',
    termsofuse_t_06: 'Взаимодействието между приложението Lampa и themoviedb.org се осъществява чрез API заявки, които се изпращат от приложението Lampa към сървърите на themoviedb.org за получаване на информация и медийни файлове. Themoviedb.org обработва заявките и изпраща поисканите данни обратно към приложението Lampa.',
    termsofuse_t_07: 'Така, благодарение на използването на API на themoviedb.org, приложението Lampa предоставя на потребителите достъп до обширна база данни с филми и телевизионни сериали, като същевременно спазва условията за ползване и ограниченията, определени от носителя на авторските права.',
    termsofuse_t_08: 'Разширения',
    termsofuse_t_09: 'Разширенията са мощен инструмент, предоставен за приложението Lampa, който позволява на потребителите да разширят неговите възможности, да добавят допълнителни функции и да модифицират съдържанието според техните нужди.',
    termsofuse_t_10: 'Важно е да се отбележи, че потребителите инсталират разширения на свой собствен риск. Всички последици от използването на разширения са отговорност на потребителя. Препоръчва се потребителите да бъдат внимателни при инсталиране и използване на разширения, като внимателно оценяват тяхната надеждност и сигурност.',
    termsofuse_t_11: 'Нарушения на авторските права',
    termsofuse_t_12: 'Ако откриете нарушение на авторските права в приложението Lampa, трябва да се свържете с разработчиците на приложението Lampa. Можете да използвате контактите, предоставени в приложението Lampa, за тази цел. Важно е обаче да се отбележи, че приложението Lampa използва API от каталога themoviedb.org, който предоставя открит достъп до информация за филми и телевизионни сериали. Това означава, че информацията, показвана в приложението Lampa, е публично достъпна и не нарушава авторските права.',
    termsofuse_t_13: 'Ако смятате, че приложението Lampa все още съдържа съдържание, което нарушава вашите авторски права, можете да се свържете с носителя на авторските права на това съдържание и да поискате неговото премахване от уебсайта themoviedb.org. От своя страна, приложението Lampa може да премахне съдържание при получаване на надлежно уведомление за нарушение на авторските права.',
    ...
    account_qr_premium: 'Сканирайте QR кода, за да научите повече за CUB Premium',
    account_qr_code: 'Сканирайте QR кода, за да получите код за свързване на устройство',
    account_qr_create: 'Сканирайте QR кода, за да създадете акаунт',
    account_add_device_title: 'Добавяне на устройство',
    account_add_device_text: 'Отидете на <span class="account-modal__site">{site}/add</span>, за да получите код за добавяне на устройство.',
    account_none_title: 'Все още нямате акаунт?',
    account_none_include_1: 'Отметките и историята на гледане се съхраняват в облака',
    account_none_include_2: 'Синхронизация между устройства',
    account_none_include_3: 'Известия за нови епизоди и издания',
    account_none_include_4: 'Създавайте няколко профила под един акаунт',
    account_premium_include_1: 'Повече отметки',
    account_premium_include_2: 'Разширена история на гледане',
    account_premium_include_3: 'Повече налични таймкодове',
    account_premium_include_4: 'Брой профили на акаунт',
    empty_subscribes_title: 'Вашите абонаменти за преводи',
    empty_subscribes_text: 'Просто се абонирайте за любимия си превод и ще ви уведомим, когато излезе нов епизод.',
    ...
    account_discuss_add_qr: 'Сканирайте QR кода',
    account_discuss_add_title: 'Искате да оставите коментар?',
    account_discuss_add_text: 'Сканирайте QR кода, за да отворите приложението и да добавите коментар за този филм или сериал. <br><br> - Вземете телефона или таблета си <br> - Отворете камерата <br> - Насочете я към QR кода <br> - Следвайте връзката, която ще се появи на екрана',
    account_discuss_added: 'Благодарим за вашия коментар!',
    account_discuss_added_ready: 'Вече сте оставили коментар за този филм или сериал.',
    remote_helper_long: 'Задръжте бутона (OK), за да отворите менюто',
    account_premium: 'Отключете нови хоризонти с акаунт CUB Premium! Насладете се на увеличени лимити и разширени функции на услугата. Посетете <span class="account-modal__site">{site}/premium</span>, за да научите повече за предимствата на премиум акаунта.',
